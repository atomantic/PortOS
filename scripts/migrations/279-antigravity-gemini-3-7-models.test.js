/**
 * Test for migration 279 — update Antigravity CLI and TUI model catalog to include Gemini 3.7.
 */
...
import migration from './279-antigravity-gemini-3-7-models.js';
...
describe('migration 279 — Antigravity Gemini 3.7 model catalog', () => {
  let rootDir;
  let providersPath;
