...
import migration from './165-editorial-world-unforeshadowed-solution-stage.js';
...
const FILENAME = 'pipeline-editorial-world-unforeshadowed-solution.md';
const STAGE_KEY = 'pipeline-editorial-world-unforeshadowed-solution';
const BODY = '# Unforeshadowed solution\n\nshipped body\n';

describe('migration 165 — seed editorial-world-unforeshadowed-solution stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
