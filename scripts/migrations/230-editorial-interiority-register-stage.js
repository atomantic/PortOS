/**
 * Seed the interiority-register editorial-check stage into existing installs (#3593).
 *
 * Mirrors `229-editorial-reported-speech-stage.js`: copies the `.md` template
 ...
 * `interiority.register` editorial check would throw "Stage not found" the
 * first time it runs.
 *
...
export default makeSeedMigration('pipeline-editorial-interiority-register');
