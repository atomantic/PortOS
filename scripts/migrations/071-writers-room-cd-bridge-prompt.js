/**
 * Seed the Writers Room Creative-Director-bridge prompt stage into existing installs.
 *
 * Single-stage sibling of the other writers-room prompt seeds (see migration
 * 065): copies the `writers-room-cd-bridge.md` template from
 ...
 * first cd-bridge suggest call would throw "Stage not found".
 *
...
const STAGE = 'writers-room-cd-bridge';
