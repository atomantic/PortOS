...
import migration from './166-editorial-world-cost-free-power-stage.js';
...
const FILENAME = 'pipeline-editorial-world-cost-free-power.md';
const STAGE_KEY = 'pipeline-editorial-world-cost-free-power';
const BODY = '# Cost-free power\n\nshipped body\n';

describe('migration 166 — seed editorial-world-cost-free-power stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-166-'));
