...
| `CollapsibleListItem` | Successful-delete row collapse with reduced-motion support and focus transfer; set `removing`, then filter local state in `onExited`. Owns row spacing. |
