  ...
  return (
    <div className="flex items-center gap-2 py-1.5">
      ...
      <div className="text-right">
        <div className="text-sm font-bold text-white">{typeof value === 'number' ? formatCount(value) : value}</div>
  ...
  return (
    <div className="bg-port-card border border-port-border rounded-lg p-4 h-full">
      ...
      <div className="divide-y divide-port-border">
        ...
        <CompactStat icon={Moon} iconColor="text-indigo-400" label="Sleep" value={`${Math.round(r.sleepHours / 24 / 365.25)}y`} sub={`${formatCount(r.sleepHours)}h`} />
