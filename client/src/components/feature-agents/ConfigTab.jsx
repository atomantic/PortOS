...
export default function ConfigTab({ agent, isCreate, apps, onSave }) {
  const [form, setForm] = useState({
    ...
    schedule: { mode: 'continuous', cronExpression: '', intervalMs: 3600000, pauseBetweenRunsMs: 60000 },
  ...
  useEffect(() => {
    if (agent && !isCreate) {
      setForm({
        ...
        schedule: agent.schedule || { mode: 'continuous', cronExpression: '', intervalMs: 3600000, pauseBetweenRunsMs: 60000 },
