    ...
    <div className="min-w-0 max-w-full space-y-3">
      ...
      <ImageGenGallerySections
        gallery={{
          ...
          hiddenError, hasMoreHidden, hiddenLoading, loadMoreHidden, setFavoritesOnly,
        }}
        cards={{
      ...
      <ImageGenOverlays
        preview={{
          value: preview, set: setPreview, items: previewItems, annotations, updateAnnotation,
          ...
          regenAvailable, regenBounds: regenInfo,
        }}
        galleryPicker={{ value: galleryPicker, onClose: () => setGalleryPicker(null), onSelect: handleGallerySelect }}
        settings={{ open: settingsOpen, onClose: closeSettings }}
        flux2={{ open: flux2InstallOpen, onClose: handleFlux2ModalClose, onComplete: handleFlux2InstallComplete, modelId }}
      />
    </div>
  );
}
