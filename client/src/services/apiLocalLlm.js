...
export const getLoadedLlmModels = () => request('/local-llm/loaded');
...
export const unloadOllamaModel = (modelId) =>
  request('/local-llm/unload', { method: 'POST', body: JSON.stringify({ backend: 'ollama', modelId }) });
