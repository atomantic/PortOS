...
| `apiCodeAnimation.js` | Code Animation: host-contract options, LLM-written briefs from a universe, universe-styled LLM prompt building for a procedurally coded animation film, and provider generation jobs (start + poll for the HTML). |
