...
| `apiCodeAnimation.js` | Code Animation: host-contract options, universe-styled LLM prompt building for a procedurally coded animation film, and provider generation jobs (start + poll for the HTML). |
