...
| NFR-10 | Performance | Long-running external calls (git operations, LLM provider calls, local-model inference) MUST have explicit timeout constants rather than blocking indefinitely. |
