...
describe('peerSync', () => {
  describe('PEER_SUBSCRIBABLE_KINDS', () => {
    it('is exactly [universe, series, mediaCollection, author, artist, album, track, creativeDirectorProject, moodBoard]', () => {
      ...
      expect(PEER_SUBSCRIBABLE_KINDS).toEqual(['universe', 'series', 'mediaCollection', 'author', 'artist', 'album', 'track', 'creativeDirectorProject', 'moodBoard']);
    });
  });
