...
describe('instances.js', () => {
  ...
  // --- Self Identity is services/instanceIdentity.test.js (#6836) ---
  ...
  describe('fullSync (full-mirror) peer mode', () => {
    ...
    // updateSelf itself (including the defaultPeerFullSync field this block's
    // addPeer tests rely on) is covered by instanceIdentity.test.js (#6836).
  });
