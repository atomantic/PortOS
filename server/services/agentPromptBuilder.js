...
- A browser bridge is usable for this audit only if it can attach to the dedicated PortOS tab described below without creating a page or bringing the browser window to the front. Otherwise use the configured CDP endpoint from the local shell, including when the provider bridge is empty or unusable.
