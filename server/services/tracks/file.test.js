...
// chiptuneScore/chiptunePrompt/waveSketch/waveSketchPrompt default to sanitizeTrack's own untouched shape
...
const track = (id, extra = {}) => ({
  ...
  chiptuneScore: null, chiptunePrompt: '', waveSketch: null, waveSketchPrompt: '',
