 ...
 * sub-agent that records proposals in the app's CONFIGURED work tracker
 * (PLAN.md / GitHub / GitLab / JIRA) for `/claim` / `plan-task` /
 * `claim-issue*` to pick up. PLAN.md keeps checklist IDs; forge issues use
 * human-readable titles and their issue number/key as the ID.
 *
