...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.media.3d', path: '/media/3d', label: '3D', section: 'Create', aliases: ['3d', 'image-to-mesh', 'mesh', 'trellis', 'neural-3d'], keywords: ['trellis', 'glb', 'mesh', 'photogrammetry', 'neural', 'image to 3d', 'install', 'model', 'pbr'] },
