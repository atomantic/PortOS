...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.timeline', path: '/timeline', label: 'Timeline', section: 'Brain', aliases: ['activity-timeline', 'activity', 'my-day', 'life-log', 'life-timeline'], keywords: ['human activity', 'life log', 'timeline', 'messages', 'calendar', 'history', 'what did i do', 'daily'] },
  ...
  { id: 'nav.settings.branch-reconcile', path: '/settings/branch-reconcile', label: 'Branch Reconcile', section: 'Settings', aliases: ['branch-reconcile', 'reconcile', 'settings-branch-reconcile', 'branch-pr-reconciler'], keywords: ['branch', 'pr', 'pull request', 'merge', 'worktree', 'cleanup', 'unfinished', 'orphaned', 'stale branches'] },
