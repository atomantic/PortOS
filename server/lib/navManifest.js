...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.models.subscriptions', path: '/models/subscriptions', label: 'Subscriptions', section: 'Models', tabId: 'subscriptions', aliases: ['model-subscriptions', 'subscription', 'billing', 'ai-billing'], keywords: ['subscription', 'plan', 'billing', 'cost', 'usage', 'quotas'] },
