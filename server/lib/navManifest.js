...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.models.llms.jev', path: '/models/llms/jev', label: 'jev', section: 'Models', aliases: ['jev', 'openjev', 'entailment', 'nli', 'decision-scorer'], keywords: ['entailment', 'nli', 'closed set', 'abstain', 'margin', 'scorer', 'decision', 'install jev'] },
