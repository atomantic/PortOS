...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.models.llms.jev', path: '/models/llms/jev', label: 'Jev decision scorer', section: 'Models', tabId: 'jev', navGroup: 'Policies', aliases: ['jev', 'openjev', 'entailment', 'nli', 'decision-scorer'], keywords: ['entailment', 'nli', 'closed set', 'abstain', 'margin', 'scorer', 'decision', 'install jev'] },
