...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.brain.ideas', path: '/brain/ideas', label: 'Ideas', section: 'Brain', aliases: ['brain-ideas', 'ideas'], keywords: ['brainstorm', 'creative', 'thought', 'concept', 'idealoom', 'idea loom'] },
