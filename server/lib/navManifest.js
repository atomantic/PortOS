...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.media.prompt', path: '/media/prompt', label: 'Prompt from Media', tabLabel: 'Prompt', section: 'Create', tabGroup: 'media', tabId: 'prompt', aliases: ['prompt-from-media', 'analyze-media-prompt'], keywords: ['vision', 'reverse prompt', 'describe media', 'image prompt', 'video prompt'] },
  ...
  { id: 'nav.create.code-animation', path: '/code-animation', label: 'Code Animation', section: 'Create', aliases: ['code-animation', 'codeanimation', 'code-video', 'procedural-animation', 'animation-prompt'], keywords: ['animation', 'canvas', 'webgl', 'procedural', 'no assets', 'llm prompt', 'motion graphics', 'universe style', 'mood board', 'audio reactive', 'record video', 'html animation'] },
  ...
  { id: 'nav.create.decks', path: '/decks', label: 'Decks', section: 'Create', aliases: ['decks', 'deck', 'card-deck', 'playing-cards', 'tarot', 'tarot-deck', 'cards'], keywords: ['playing cards', 'tarot', 'card deck', 'card design', 'suits', 'arcana', 'style guide', 'batch render', 'card art'] },
  ...
  { id: 'nav.twin.autobiography', path: '/digital-twin/autobiography', label: 'Autobiography', section: 'Identity', feature: 'autobiography', tabGroup: 'digital-twin', tabId: 'autobiography', aliases: ['twin-autobiography', 'autobiography'], keywords: ['sources'] },
  ...
  // A task view of Code Reviewers, not a second sidebar destination. No tabId,
  // so the section navigator stays on Code Reviewers while ⌘K and voice can
  // still open the follow-up check directly.
  { id: 'nav.models.code-reviewers.follow-up', path: '/models/code-reviewers/follow-up', label: 'Reviewer follow-up', section: 'Models', aliases: ['reviewer-follow-up', 'goal-fidelity', 'code-review-follow-up'], keywords: ['objective', 'fidelity', 'rethink', 'file issue', 'finished run', 'follow-up'] },
  ...
  { id: 'nav.models.performance.results', path: '/models/performance/results', label: 'Performance Results', section: 'Models', aliases: ['performance-results', 'assessment-results'], keywords: ['measured results', 'model evidence', 'selected evidence', 'rankings'] },
  { id: 'nav.models.performance.capabilities', path: '/models/performance/capabilities', label: 'Performance Capabilities', section: 'Models', aliases: ['performance-capabilities', 'model-capability-tests'], keywords: ['capability tests', 'model abilities', 'saved capability results'] },
  { id: 'nav.models.performance.agent-checks', path: '/models/performance/agent-checks', label: 'Performance Agent Checks', section: 'Models', aliases: ['performance-agent-checks', 'model-agent-checks'], keywords: ['opencode', 'tui', 'agent task', 'pty'] },
  { id: 'nav.models.performance.tuning', path: '/models/performance/tuning', label: 'Performance Tuning', section: 'Models', aliases: ['performance-tuning', 'assessment-tuning'], keywords: ['tuning comparison', 'sweep', 'launch knobs', 'tokens per second'] },
  ...
  { id: 'nav.settings.security', path: '/settings/security', label: 'Security', section: 'Settings', tabId: 'security', aliases: ['security', 'password', 'auth', 'settings-security', 'login-password', 'auth-password', 'password-settings'], keywords: ['security', 'password', 'instance password', 'login', 'auth', 'authentication', 'sign-in', 'lock', 'tailnet', 'network security', 'sidecar'] },
  ...
  { id: 'nav.security', path: '/security', label: 'Security Camera', section: 'Dev Tools', aliases: ['security-camera', 'camera-monitor', 'security-feed'], keywords: ['camera', 'webcam', 'microphone', 'audio level', 'feed'] },
