...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.media.video', path: '/media/video', label: 'Video', section: 'Create', tabGroup: 'media', tabId: 'video', previousPaths: ['/video-gen'], aliases: ['video-gen', 'videogen', 'generate-video', 'ltx'], keywords: ['video', 'animate', 'movie', 'clip', 'ltx', 'episode composer', 'continuous video', 'multi-scene'] },
