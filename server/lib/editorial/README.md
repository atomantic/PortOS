...
| `findingCategories.js` | Browser-safe human labels for built-in editorial-check and manuscript-completeness finding categories, shared by the registry parity guard and manuscript editor. |
