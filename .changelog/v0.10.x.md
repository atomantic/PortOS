...
- **Provider Management**: Scaffolded projects have `/api/providers` endpoints for managing AI providers (CLI or API-based)
...
- **Automatic Symlink**: Template creates symlinks to PortOS's ai-toolkit package for shared functionality
