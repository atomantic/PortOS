...
**Client changes**:
- `client/src/components/agents/tabs/ToolsTab.jsx` — Full-featured tools UI with feed browser, post/comment composers, and engage button
- `client/src/services/api.js` — Added 11 new API functions for agent tools
