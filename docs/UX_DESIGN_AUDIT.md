...
- Settings General and Backup, Brain Threads and Notes, and the Apps list and detail: source and rendered-test review only; #7858 now has a synthetic validation record, while complete browser geometry and accessibility certification remain out of scope.
