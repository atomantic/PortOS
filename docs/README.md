...
- [Provider connections and harnesses design](./plans/2026-09-06-provider-connections-and-harnesses.md) — durable connection identity with stable executable routes, migration and management flows.
